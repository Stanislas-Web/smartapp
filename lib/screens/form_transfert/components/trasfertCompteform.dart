...
class TransfertCompteForm extends StatefulWidget {
  @override
  _TransfertCompteFormState createState() => _TransfertCompteFormState();
}

class _TransfertCompteFormState extends State<TransfertCompteForm> {
  ...
  List banque = ["Rawbank", "Equity", "United Bank for Africa"];
    ...
    return Form(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: getProportionateScreenHeight(20)),
          buildIdClientFormField(),
          SizedBox(height: getProportionateScreenHeight(20)),
          buildNomFormField(),
          SizedBox(height: getProportionateScreenHeight(20)),
          buildNumeroCarteFormField(),
          SizedBox(height: getProportionateScreenHeight(20)),
          buildCVVFormField(),
          SizedBox(height: getProportionateScreenHeight(20)),
          buildDataExpiFormField(),
          SizedBox(height: getProportionateScreenHeight(20)),
